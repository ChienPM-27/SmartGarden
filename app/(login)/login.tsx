...
import styles from '../(Main)/ChatBox/chatbox.styles';
    ...
    useEffect(() => {
        if (messages.length === 0) {
            const welcomeMessage: Message = {
                id: 'welcome',
                text: '🌱 Chào mừng bạn đến với SmartGarden! Tôi là trợ lý AI chuyên về cây trồng. Bạn có thể hỏi tôi về chăm sóc cây, nhận biết bệnh hại, hoặc gửi ảnh cây để tôi phân tích nhé! 🌿',
                sender: 'bot',
                timestamp: Date.now(),
            };
